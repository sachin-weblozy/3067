            ...
            <div class="container">
                ...
                <div class="services">
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            <a href="{{ route('product.opulum') }}" class="service-card mt-150 wow fadeInUp" data-wow-delay="0.4s">
                                <div class="icon">
                        ...
                        <div class="col-lg-3">
                            <a href="{{ route('product.textura') }}" class="service-card wow fadeInUp" data-wow-delay="0.6s">
                                ...
                                <h5 class="fsz-24 mb-20"> Textura - Textured Pre-Laminated Panels (6') </h5>
                                <div class="img">
                        ...
                        <div class="col-lg-3">
                            <a href="{{ route('product.velvetmatte') }}" class="service-card mt-150 wow fadeInUp" data-wow-delay="0.8s">
                                <div class="icon">
                                    <i class="la la-comments"></i>
                                </div>
                                <h5 class="fsz-24 mb-20"> VelvetMatte - Super Matte UV Finish (Up to 6' Width)</h5>
                                <div class="img">
                        ...
                        <div class="col-lg-3">
                            <a href="{{ route('product.velvetgloss') }}" class="service-card wow fadeInUp" data-wow-delay="0.8s">
                                <div class="icon">
                                    <i class="la la-comments"></i>
                                </div>
                                <h5 class="fsz-24 mb-20"> VelvetGloss - High Gloss UV Finish (Up to 6' Width)</h5>
                                <div class="img">
                        ...
                        <div class="col-lg-3">
                            <a href="{{ route('product.lucentacrylic') }}" class="service-card mt-150 wow fadeInUp" data-wow-delay="0.8s">
                                <div class="icon">
                                    <i class="la la-comments"></i>
                                </div>
