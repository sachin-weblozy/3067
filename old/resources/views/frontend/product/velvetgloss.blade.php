@component('layouts.frontend')
    ...
    <header class="s-header-style2">
        <div class="container">
            <div class="info">
                <h1 class="title"> Velvet Gloss High Gloss UV Finish </h1>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row gx-0">
                ...
                <img src="{{ asset('assets/img/upArrow.svg') }}" alt="upArrow">
                    <h6 class="fsz-24 fw-500 mt-4 mt-lg-0 wow fadeInUp slow" data-wow-delay="0.2s"> VelvetGloss sets the standard for high-gloss surfaces, delivering a stunning finish with a gloss level above 95. Engineered for perfection, VelvetGloss panels are designed to elevate any space with their reflective beauty and durability. </h6>
</div>
<!-- <div class="container-card">
                <img src="{{ asset('assets/img/upArrow.svg') }}" alt="upArrow">
                ...
                <div class="row">
                    <div class="col-lg-3">
                        <div class="sm-img wow zoomIn slow" data-wow-delay="0.2s">
                            <img src="{{ asset('assets/img/velvet-gloss/velvet-gloss-3.webp') }}" alt="" class="img-cover"
                                data-speed="1.5">
                        </div>
                        <div class="lg-img wow zoomIn slow" data-wow-delay="0.4s">
                            <img src="{{ asset('assets/img/velvet-gloss/velvet-gloss-4.webp') }}" alt="" class="img-cover"
                                data-speed="1.5">
                        </div>
                    </div>
                    <div class="col-lg-6 ">
                        <div class="lg-img wow zoomIn slow" data-wow-delay="0.4s">
                            <img src="{{ asset('assets/img/velvet-gloss/velvet-gloss-5.webp') }}" alt="" class="img-cover"
                                data-speed="1.5">
                        </div>
                        <div class="sm-img wow zoomIn slow" data-wow-delay="0.2s">
    ...
    <section class="tc-challenge-style2">
        <div class="container">
            <h3 class="fsz-45 text-capitalize mb-60 js-splittext-lines"> Phoenix VelvetGloss Collection</h3>
            <div class="text fsz-24 mb-100 wow fadeInUp slow" data-wow-delay="0.2s"> Crafted from superior MDF, Particle Board, HDHMR, and more, ensuring reliable performance and longevity. With widths up to 6 feet, VelvetGloss panels cater to projects of any size, offering flexibility for design creativity. Gloss level exceeding 95 delivers a reflective surface that exudes elegance and amplifies light within your space.Choose from all PreLam shades, including solid colors, wood grains, and designer prints. Available in 5mm to 25mm
            </div>
        </div>
