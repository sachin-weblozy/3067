                ...
                <div class="cases">
                    <div class="cases-content wow fadeInUp slow" data-wow-delay="0.4s">
                        <div class="row mixitup">
                            ...
                            <div class="col-lg-4 mix-item">
                                <div class="case-card">
                                    <a href="{{ route('product.velvetmatte') }}" class="img">
                                        <img src="{{ asset('assets/img/services/velvetmatte-super-matte-uv-finish.webp') }}" alt="" class="img-cover">
                                    </a>
                                    <div class="info">
                                        <h3 class="title fsz-35 mb-20"> <a href="{{ route('product.velvetmatte') }}" class="hover-orange1">
                                            VelvetMatte - Super Matte UV Finish (Up to 6' Width) </a> </h3>
                                        <div class="text color-666"> Luxurious matte UV panels with a gloss level below 5, offering a smooth, modern finish. </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 mix-item">
                                <div class="case-card">
                                    <a href="{{ route('product.velvetgloss') }}" class="img">
                                        <img src="{{ asset('assets/img/services/velvetgloss-high-gloss-uv-finish.webp') }}" alt="" class="img-cover">
                                    </a>
                                    <div class="info">
                                        <h3 class="title fsz-35 mb-20"> <a href="{{ route('product.velvetgloss') }}" class="hover-orange1">
                                            VelvetGloss - High Gloss UV Finish (Up to 6' Width) </a> </h3>
                                        <div class="text color-666"> High-gloss UV panels with a stunning gloss level above 95, perfect for a sleek and shiny appearance.
                                        </div>
                                    </div>
                                </div>
                            </div>
